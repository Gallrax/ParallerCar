...
<div class="column grid-16">
    <div class="inbox">
        <div class="inbox-title">车源管理<a href="${pageContext.request.contextPath}/saleInfo/writeSaleInfo" class="inbox-right">发布车源信息&gt;&gt;</a></div>
            ...
            success : function(data) {
                ...
                if(data != ""){
                    for(var i = 0; i < data.length; i++){
                        str += "<tr><td>"+ data[i].car.name +"</td><td><a href=\"#\">"+ data[i].title +"</a></td><td>"+ data[i].price +"</td><td>"+ data[i].insertTime +"</td><td class=\"lasttd\"><a href=\"${pageContext.request.contextPath}/saleInfo/writeSaleInfo?id="+ data[i].id +"\">修改</a>&nbsp;&nbsp;<a href=\"${pageContext.request.contextPath}/saleInfo/deleteSaleInfo?id="+ data[i].id +"\" >删除</a></td></tr>\";"
                    }
                    $("#fi").after(str);
                }
            }
